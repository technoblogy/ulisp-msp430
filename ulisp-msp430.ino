/* uLisp MSP430 Version 2.6 - www.ulisp.com
   David Johnson-Davies - www.technoblogy.com - 18th April 2019
...
WITHSERIAL, WITHI2C, WITHSPI, WITHSDCARD, WITHLCD, TAIL_FORMS, PROGN, RETURN, IF, COND, WHEN, UNLESS,
...
const char string29[] PROGMEM = "with-lcd";
...
const char string84[] PROGMEM = "truncate";
...
const char string105[] PROGMEM = "char";
const char string106[] PROGMEM = "char-code";
const char string107[] PROGMEM = "code-char";
const char string108[] PROGMEM = "characterp";
const char string109[] PROGMEM = "stringp";
const char string110[] PROGMEM = "string=";
const char string111[] PROGMEM = "string<";
const char string112[] PROGMEM = "string>";
const char string113[] PROGMEM = "sort";
const char string114[] PROGMEM = "string";
const char string115[] PROGMEM = "concatenate";
const char string116[] PROGMEM = "subseq";
const char string117[] PROGMEM = "read-from-string";
const char string118[] PROGMEM = "princ-to-string";
const char string119[] PROGMEM = "prin1-to-string";
const char string120[] PROGMEM = "logand";
const char string121[] PROGMEM = "logior";
const char string122[] PROGMEM = "logxor";
const char string123[] PROGMEM = "lognot";
const char string124[] PROGMEM = "ash";
const char string125[] PROGMEM = "logbitp";
const char string126[] PROGMEM = "eval";
const char string127[] PROGMEM = "globals";
const char string128[] PROGMEM = "locals";
const char string129[] PROGMEM = "makunbound";
const char string130[] PROGMEM = "break";
const char string131[] PROGMEM = "read";
const char string132[] PROGMEM = "prin1";
const char string133[] PROGMEM = "print";
const char string134[] PROGMEM = "princ";
const char string135[] PROGMEM = "terpri";
const char string136[] PROGMEM = "read-byte";
const char string137[] PROGMEM = "read-line";
const char string138[] PROGMEM = "write-byte";
const char string139[] PROGMEM = "write-string";
const char string140[] PROGMEM = "write-line";
const char string141[] PROGMEM = "restart-i2c";
const char string142[] PROGMEM = "gc";
const char string143[] PROGMEM = "room";
const char string144[] PROGMEM = "save-image";
const char string145[] PROGMEM = "load-image";
const char string146[] PROGMEM = "cls";
const char string147[] PROGMEM = "pinmode";
const char string148[] PROGMEM = "digitalread";
const char string149[] PROGMEM = "digitalwrite";
const char string150[] PROGMEM = "analogread";
const char string151[] PROGMEM = "analogwrite";
const char string152[] PROGMEM = "delay";
const char string153[] PROGMEM = "millis";
const char string154[] PROGMEM = "sleep";
const char string155[] PROGMEM = "note";
...
const tbl_entry_t lookup_table[] PROGMEM = {
  ...
  { string83, fn_divide, 2, 127 },
  { string84, fn_divide, 1, 2 },
  { string85, fn_mod, 2, 2 },
  ...
  { string105, fn_char, 2, 2 },
  { string106, fn_charcode, 1, 1 },
  { string107, fn_codechar, 1, 1 },
  { string108, fn_characterp, 1, 1 },
  { string109, fn_stringp, 1, 1 },
  { string110, fn_stringeq, 2, 2 },
  { string111, fn_stringless, 2, 2 },
  { string112, fn_stringgreater, 2, 2 },
  { string113, fn_sort, 2, 2 },
  { string114, fn_stringfn, 1, 1 },
  { string115, fn_concatenate, 1, 127 },
  { string116, fn_subseq, 2, 3 },
  { string117, fn_readfromstring, 1, 1 },
  { string118, fn_princtostring, 1, 1 },
  { string119, fn_prin1tostring, 1, 1 },
  { string120, fn_logand, 0, 127 },
  { string121, fn_logior, 0, 127 },
  { string122, fn_logxor, 0, 127 },
  { string123, fn_lognot, 1, 1 },
  { string124, fn_ash, 2, 2 },
  { string125, fn_logbitp, 2, 2 },
  { string126, fn_eval, 1, 1 },
  { string127, fn_globals, 0, 0 },
  { string128, fn_locals, 0, 0 },
  { string129, fn_makunbound, 1, 1 },
  { string130, fn_break, 0, 0 },
  { string131, fn_read, 0, 1 },
  { string132, fn_prin1, 1, 2 },
  { string133, fn_print, 1, 2 },
  { string134, fn_princ, 1, 2 },
  { string135, fn_terpri, 0, 1 },
  { string136, fn_readbyte, 0, 2 },
  { string137, fn_readline, 0, 1 },
  { string138, fn_writebyte, 1, 2 },
  { string139, fn_writestring, 1, 2 },
  { string140, fn_writeline, 1, 2 },
  { string141, fn_restarti2c, 1, 2 },
  { string142, fn_gc, 0, 0 },
  { string143, fn_room, 0, 0 },
  { string144, fn_saveimage, 0, 1 },
  { string145, fn_loadimage, 0, 1 },
  { string146, fn_cls, 0, 0 },
  { string147, fn_pinmode, 2, 2 },
  { string148, fn_digitalread, 1, 1 },
  { string149, fn_digitalwrite, 2, 2 },
  { string150, fn_analogread, 1, 1 },
  { string151, fn_analogwrite, 2, 2 },
  { string152, fn_delay, 1, 1 },
  { string153, fn_millis, 0, 0 },
  { string154, fn_sleep, 1, 1 },
  { string155, fn_note, 0, 3 },
